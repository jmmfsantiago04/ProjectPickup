...
export default function Warehouse() {
  ...
  return (
    <section className="py-24 w-full max-w-[1000px] mx-auto flex flex-col justify-center items-center">
      <h1 className="text-[2.5rem] leading-[3.405rem] font-bold text-center mb-[3.4375rem]">Warehouse</h1>
      ...
      <section className="bg-primaryBeige p-16 rounded-3xl w-[51.875rem]  flex-col justify-start my-24 mx-[5.3125rem]">
